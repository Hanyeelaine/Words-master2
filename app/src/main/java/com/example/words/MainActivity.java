...
public class MainActivity extends AppCompatActivity
    ...
    private void InsertDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
                builder.setTitle("添加新的单词");//标题
                builder.setView(tableLayout);//设置视图
    ...
    private void onlineNews(){
        Intent intent= new Intent();
        intent.setAction("android.intent.action.VIEW");
        Uri content_url = Uri.parse("http://www.chinadaily.com.cn/");
    ...
    private void onlineTrans(){
        Intent intent= new Intent();
        intent.setAction("android.intent.action.VIEW");
        Uri content_url = Uri.parse("https://translate.google.cn");
        intent.setData(content_url);
        startActivity(intent);
    }
